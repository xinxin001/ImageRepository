...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { caption: @picture.caption, title: @picture.title } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { caption: @picture.caption, title: @picture.title } }
